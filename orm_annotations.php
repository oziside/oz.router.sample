...
/* ORMENTITYANNOTATION:App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductTable */
namespace App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM {
	/**
	 * ProductObject
	 * @see \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductTable
	 *
	 * Custom methods:
	 * ---------------
	 *
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setTimestampX(\Bitrix\Main\Type\DateTime|\Bitrix\Main\DB\SqlExpression $timestampX)
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetActiveFrom()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetActiveFrom()
	 * @method \Bitrix\Main\Type\DateTime fillActiveFrom()
	 * @method \Bitrix\Main\Type\DateTime getActiveTo()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setActiveTo(\Bitrix\Main\Type\DateTime|\Bitrix\Main\DB\SqlExpression $activeTo)
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetShowCounterStart()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetShowCounterStart()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setIblock(\Bitrix\Iblock\Iblock $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetIblock()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetIblock()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setWfParentElement(\Bitrix\Iblock\EO_Element $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetWfParentElement()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetWfParentElement()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setIblockSection(\Bitrix\Iblock\EO_Section $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetIblockSection()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetIblockSection()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setModifiedByUser(\Bitrix\Main\EO_User $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetModifiedByUser()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetModifiedByUser()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setCreatedByUser(\Bitrix\Main\EO_User $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetCreatedByUser()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetCreatedByUser()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setWfLockedByUser(\Bitrix\Main\EO_User $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetWfLockedByUser()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetWfLockedByUser()
	 ...
	 * @method \Bitrix\Catalog\EO_Product getProductMeta()
	 * @method \Bitrix\Catalog\EO_Product remindActualProductMeta()
	 * @method \Bitrix\Catalog\EO_Product requireProductMeta()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject setProductMeta(\Bitrix\Catalog\EO_Product $object)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject resetProductMeta()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unsetProductMeta()
	 * @method bool hasProductMeta()
	 * @method bool isProductMetaFilled()
	 * @method bool isProductMetaChanged()
	 * @method \Bitrix\Catalog\EO_Product fillProductMeta()
	 *
	 * Common methods:
	 * ---------------
	 *
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject set($fieldName, $value)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject reset($fieldName)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject unset($fieldName)
	 ...
	 * @method static \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject wakeUp($data)
	 */
	class EO_Product extends \Bitrix\Main\ORM\Objectify\EntityObject {
		/* @var \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductTable */
		static public $dataClass = '\App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductTable';
		/**
...
namespace App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM {
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getIblockCollection()
	 * @method \Bitrix\Iblock\EO_Iblock_Collection fillIblock()
	 * @method \Bitrix\Iblock\EO_Element[] getWfParentElementList()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getWfParentElementCollection()
	 * @method \Bitrix\Iblock\EO_Element_Collection fillWfParentElement()
	 * @method \Bitrix\Iblock\EO_Section[] getIblockSectionList()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getIblockSectionCollection()
	 * @method \Bitrix\Iblock\EO_Section_Collection fillIblockSection()
	 * @method \Bitrix\Main\EO_User[] getModifiedByUserList()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getModifiedByUserCollection()
	 * @method \Bitrix\Main\EO_User_Collection fillModifiedByUser()
	 * @method \Bitrix\Main\EO_User[] getCreatedByUserList()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getCreatedByUserCollection()
	 * @method \Bitrix\Main\EO_User_Collection fillCreatedByUser()
	 * @method \Bitrix\Main\EO_User[] getWfLockedByUserList()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getWfLockedByUserCollection()
	 * @method \Bitrix\Main\EO_User_Collection fillWfLockedByUser()
	 * @method \Bitrix\Catalog\EO_Product[] getProductMetaList()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection getProductMetaCollection()
	 * @method \Bitrix\Catalog\EO_Product_Collection fillProductMeta()
	 *
	 * Common methods:
	 * ---------------
	 *
	 * @property-read \Bitrix\Main\ORM\Entity $entity
	 * @method void add(\App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject $object)
	 * @method bool has(\App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject $object)
	 * @method bool hasByPrimary($primary)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject getByPrimary($primary)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject[] getAll()
	 * @method bool remove(\App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject $object)
	 * @method void removeByPrimary($primary)
	 * @method array|\Bitrix\Main\ORM\Objectify\Collection|null fill($fields = \Bitrix\Main\ORM\Fields\FieldTypeMask::ALL) flag or array of field names
	 * @method static \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection wakeUp($data)
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject current() Iterator
	 * @method mixed key() Iterator
	 * @method void next() Iterator
	 * @method bool valid() Iterator
	 * @method int count() Countable
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection merge(?\App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection $collection)
	 * @method bool isEmpty()
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject|null find(callable $callback)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection filter(callable $callback)
	 */
...
namespace App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM {
	 ...
	 * @method static \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject createObject($setDefaultValues = true)
	 * @method static \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection createCollection()
	 * @method static \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject wakeUpObject($row)
	 * @method static \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection wakeUpCollection($rows)
	 */
	 ...
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject fetchObject()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection fetchCollection()
	 */
	...
	/**
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject createObject($setDefaultValues = true)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection createCollection()
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObject wakeUpObject($row)
	 * @method \App\Catalog\Product\Infrastructure\Persistence\Bitrix\ORM\ProductObjectCollection wakeUpCollection($rows)
	 */
